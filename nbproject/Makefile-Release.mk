...
${OBJECTDIR}/_ext/746986994/sqlite3.o: ../glib/misc/sqlite3.c 
	...
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/746986994/sqlite3.o ../glib/misc/sqlite3.c

${OBJECTDIR}/_ext/746986994/sqlitedb.o: ../glib/misc/sqlitedb.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/746986994
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/746986994/sqlitedb.o ../glib/misc/sqlitedb.cpp

${OBJECTDIR}/semisupervisor/nbc.o: semisupervisor/nbc.cpp 
	${MKDIR} -p ${OBJECTDIR}/semisupervisor
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/semisupervisor/nbc.o semisupervisor/nbc.cpp

${OBJECTDIR}/semisupervisor/ss_dataset.o: semisupervisor/ss_dataset.cpp 
	${MKDIR} -p ${OBJECTDIR}/semisupervisor
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/semisupervisor/ss_dataset.o semisupervisor/ss_dataset.cpp

${OBJECTDIR}/semisupervisor/ss_km.o: semisupervisor/ss_km.cpp 
	${MKDIR} -p ${OBJECTDIR}/semisupervisor
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/semisupervisor/ss_km.o semisupervisor/ss_km.cpp

${OBJECTDIR}/semisupervisor/strftrspace.o: semisupervisor/strftrspace.cpp 
	${MKDIR} -p ${OBJECTDIR}/semisupervisor
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/semisupervisor/strftrspace.o semisupervisor/strftrspace.cpp

${OBJECTDIR}/sssrvd/ss_controller.o: sssrvd/ss_controller.cpp 
	${MKDIR} -p ${OBJECTDIR}/sssrvd
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/sssrvd/ss_controller.o sssrvd/ss_controller.cpp

${OBJECTDIR}/sssrvd/sssrv_main.o: sssrvd/sssrv_main.cpp 
	${MKDIR} -p ${OBJECTDIR}/sssrvd
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/sssrvd/sssrv_main.o sssrvd/sssrv_main.cpp

${OBJECTDIR}/sssrvd/stdafx.o: sssrvd/stdafx.cpp 
	${MKDIR} -p ${OBJECTDIR}/sssrvd
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/sssrvd/stdafx.o sssrvd/stdafx.cpp

${OBJECTDIR}/websrv/mong_srv.o: websrv/mong_srv.cpp 
	${MKDIR} -p ${OBJECTDIR}/websrv
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/websrv/mong_srv.o websrv/mong_srv.cpp

${OBJECTDIR}/websrv/mongoose/main.o: websrv/mongoose/main.c 
	${MKDIR} -p ${OBJECTDIR}/websrv/mongoose
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/websrv/mongoose/main.o websrv/mongoose/main.c

${OBJECTDIR}/websrv/mongoose/mongoose.o: websrv/mongoose/mongoose.c 
	${MKDIR} -p ${OBJECTDIR}/websrv/mongoose
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/websrv/mongoose/mongoose.o websrv/mongoose/mongoose.c
